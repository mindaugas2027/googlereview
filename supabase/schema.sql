...
-- ============================================================
-- Planai: vietos (locations) ir QR kodai (qr_codes)
-- Limitus (pagal user_metadata.plan_id) tikrina API maršrutai —
-- DB pusėje tik duomenys ir RLS.
-- ============================================================
...
-- QR nuskaitymai ir atsiliepimai įgauna QR / vietos nuorodas
...
-- Agreguota QR statistika (skaičiuojama DB pusėje, be eilučių grąžinimo į klientą)
...
-- Statistikos funkcijos skirtos tik servisui (API maršrutams su service_role)
